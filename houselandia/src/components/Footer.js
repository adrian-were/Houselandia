   ...
   <footer className="bg-gray-950 border-t border-gray-900 mt-10">
    <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-6 overflow-hidden sm:px-6 lg:px-8">
        ...
        <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            <p className="text-sm leading-6 text-gray-400 hover:text-violet-400 transition-colors">
                About
            </p>
            <p className="text-sm leading-6 text-gray-400 hover:text-violet-400 transition-colors">
                Contact
        ...
        {/* Social Icons - Violet glow on hover */}
        <div className="flex justify-center mt-4 space-x-6">
            <p className="text-gray-500 hover:text-violet-500 transition-all transform hover:scale-110">
